...
Detailed design reveals the internal structure and behavior of individual subsystems: the classes participating in the implementation of a specific use case (VOPC diagram), the interaction of objects over time (sequence diagrams), the behavior of a file depending on its synchronization state (state diagram), the structure of software components (component diagram), and the business-process logic of synchronization (activity diagram).
...
% ---------------------------------------------------------------------
\subsection{Interaction Diagrams (Sequence Diagrams)}
% ---------------------------------------------------------------------

Three sequence diagrams are presented, illustrating key interaction scenarios between the client, the Go API server, and the database.
